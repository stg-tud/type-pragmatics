...
(define-fun EQ-abs () Bool (forall ((VAR18 Term) (TYP11 Term) (EXP18 Term) (VAR19 Term) (TYP12 Term) (EXP19 Term)) (and (=> (= (fabs VAR18 TYP11 EXP18) (fabs VAR19 TYP12 EXP19)) (and (= VAR18 VAR19) (and (= TYP11 TYP12) (= EXP18 EXP19)))) (=> (and (= VAR18 VAR19) (and (= TYP11 TYP12) (= EXP18 EXP19))) (= (fabs VAR18 TYP11 EXP18) (fabs VAR19 TYP12 EXP19))))))
...
(define-fun EQ-bind () Bool (forall ((VAR20 Term) (TYP13 Term) (CTX5 Term) (VAR21 Term) (TYP14 Term) (CTX6 Term)) (and (=> (= (bind VAR20 TYP13 CTX5) (bind VAR21 TYP14 CTX6)) (and (= VAR20 VAR21) (and (= TYP13 TYP14) (= CTX5 CTX6)))) (=> (and (= VAR20 VAR21) (and (= TYP13 TYP14) (= CTX5 CTX6))) (= (bind VAR20 TYP13 CTX5) (bind VAR21 TYP14 CTX6))))))
(define-fun EQ-arrow () Bool (forall ((TYP15 Term) (TYP16 Term) (TYP17 Term) (TYP18 Term)) (and (=> (= (arrow TYP15 TYP16) (arrow TYP17 TYP18)) (and (= TYP15 TYP17) (= TYP16 TYP18))) (=> (and (= TYP15 TYP17) (= TYP16 TYP18)) (= (arrow TYP15 TYP16) (arrow TYP17 TYP18))))))
(define-fun EQ-nothing () Bool (and (=> (= nothing nothing) true) (=> true (= nothing nothing))))
(define-fun EQ-some () Bool (forall ((TYPE3 Term) (TYPE4 Term)) (and (=> (= (some TYPE3) (some TYPE4)) (= TYPE3 TYPE4)) (=> (= TYPE3 TYPE4) (= (some TYPE3) (some TYPE4))))))
(assert EQ-var)
(assert EQ-abs)
(assert EQ-app)
(assert EQ-empty)
...
(assert EQ-nothing)
(assert EQ-some)
(define-fun DIFF-var-abs () Bool (forall ((VAR22 Term) (VAR23 Term) (TYP19 Term) (EXP24 Term)) (distinct (var VAR22) (fabs VAR23 TYP19 EXP24))))
(define-fun DIFF-var-app () Bool (forall ((VAR24 Term) (EXP25 Term) (EXP26 Term)) (distinct (var VAR24) (app EXP25 EXP26))))
(define-fun DIFF-abs-app () Bool (forall ((VAR25 Term) (TYP20 Term) (EXP27 Term) (EXP28 Term) (EXP29 Term)) (distinct (fabs VAR25 TYP20 EXP27) (app EXP28 EXP29))))
(define-fun DIFF-empty-bind () Bool (forall ((VAR26 Term) (TYP21 Term) (CTX7 Term)) (distinct empty (bind VAR26 TYP21 CTX7))))
(define-fun DIFF-nothing-some () Bool (forall ((TYPE5 Term)) (distinct nothing (some TYPE5))))
(assert DIFF-var-abs)
(assert DIFF-var-app)
(assert DIFF-abs-app)

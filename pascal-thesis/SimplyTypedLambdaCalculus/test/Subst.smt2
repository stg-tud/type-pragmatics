...
(define-fun T-subst-var-1 () Bool (forall ((T Term) (C Term) (X Term) (E Term) (E2 Term) (T2 Term)) (=> (and (= E2 (var X)) (and (= (subst X E E2) E) (and (tcheck C E T) (tcheck (bind X T C) E2 T2)))) (tcheck C (subst X E E2) T2))))
(define-fun T-subst-var-2 () Bool (forall ((Y Term) (T Term) (C Term) (X Term) (E Term) (E2 Term) (T2 Term)) (=> (and (= E2 (var X)) (and (distinct X Y) (and (= (subst Y E E2) E2) (and (tcheck C E T) (tcheck (bind X T C) E2 T2))))) (tcheck C (subst X E E2) T2))))

...
(define-fun T-par-abs-AND-T-par-app () Bool (and (forall ((C Term)) (=> (tcheck C (fabs const-xabs const-sabs const-eabs) const-tabs) (tcheck C (fabs const-xabs const-sabs (par const-eabs)) const-tabs))) (forall ((C Term)) (=> (tcheck C (app const-eapp1 const-eapp2) const-tapp) (tcheck C (app (join (fork (par const-eapp1))) (join (fork (par const-eapp2)))) const-tapp)))))
(assert (! T-par-abs-AND-T-par-app))
(check-sat)

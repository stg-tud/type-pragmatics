...
import de.tu_darmstadt.veritas.scalaspl.typechecker.{ReflectionHelper, SyntaxDirectedTypeCheckerGenerator}
import de.tu_darmstadt.veritas.scalaspl.QLSpec._
import org.scalatest.FunSuite

class SyntaxDirectedTCGTest extends FunSuite {
  private val qlSpecFile =
    new File("src/test/scala/de/tu_darmstadt/veritas/scalaspl/QLSpec.scala")

...
import de.tu_darmstadt.veritas.VerificationInfrastructure.lemmagen.clever.{DefaultGeneratorPipeline, LemmaGeneratorPipeline, PredicatePreservationConstructor, ProgressConstructor}
...
class SQLCleverLemmaGenerationTest extends FunSuite {
  ...
  val generator = new DefaultGeneratorPipeline(problem)

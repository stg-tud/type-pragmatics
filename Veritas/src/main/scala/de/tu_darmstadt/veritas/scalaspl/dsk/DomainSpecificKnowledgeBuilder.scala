...
import de.tu_darmstadt.veritas.scalaspl.lang.{FailableAnnotations, DomainSpecificKnowledgeAnnotations, ScalaSPLSpecification}
...
trait FailableDomainSpecificKnowledgeBuilder extends DomainSpecificKnowledgeBuilder[ScalaSPLSpecification with FailableAnnotations, FailableDomainSpecificKnowledge] {
  import scala.meta._
...
object FailableDomainSpecificKnowledgeBuilder {
  def apply(): FailableDomainSpecificKnowledgeBuilder =
    new FailableDomainSpecificKnowledgeBuilder {
      override val reporter = Reporter()
    }
}

...
class AdditionalPremises(problem: Problem, premiseHints: Seq[String], irrelevantVariables: Seq[String]) extends Hint {
  override def apply(baseLemma: Lemma,
    ...
    (newLemma,
      post,
      constrained ++ newIrrelevantVariables)
  }
}
...
object AdditionalPremises {
  def fromDSK(problem: Problem, function: FunctionDef): AdditionalPremises = {
    ...
    new AdditionalPremises(problem, premises, irrelevantVariables)
  }
}
 ...
 */
public class backend_strategy_0_0 extends Strategy {

	public static backend_strategy_0_0 instance = new backend_strategy_0_0();

	@Override
	public IStrategoTerm invoke(Context context, IStrategoTerm current) {
		return Backend$.MODULE$.runAsStrategy(context, current);
	}

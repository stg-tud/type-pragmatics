 ...
 */
public class backend_proof_strategy_0_0 extends Strategy {

	public static backend_proof_strategy_0_0 instance = new backend_proof_strategy_0_0();

	@Override
	public IStrategoTerm invoke(Context context, IStrategoTerm current) {
		return Backend$.MODULE$.runAsProofStrategy(context, current);
	}
